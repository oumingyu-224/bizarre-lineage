/**
 * 网站基础配置 (CommonJS)
 * Site Configuration for CommonJS
 */

const siteConfig = {
  name: "Bizarre Lineage",
  description: "Master Bizarre Lineage, the JoJo-inspired Roblox RPG where you unlock powerful Stands, battle bosses in Morioh, and dominate PvP combat.",
